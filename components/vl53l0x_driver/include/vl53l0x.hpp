...
// ═══════════════════════════════════════════════════════════════
// VL53L0X DRIVER CONFIGURATION - EDIT ALL SETTINGS HERE
// ═══════════════════════════════════════════════════════════════
...
#define VL53L0X_XSHUT_PIN        GPIO_NUM_NC  // GPIO_NUM_NC if not used
#define VL53L0X_IO_2V8           true
#define VL53L0X_TIMEOUT_MS       500
#define VL53L0X_TIMING_BUDGET_US 200000
#define VL53L0X_SIGNAL_RATE_MCPS 0.25f
// ═══════════════════════════════════════════════════════════════

/**
 * @brief VL53L0X ToF Driver - Simple and Explicit Implementation
 *
...
public:
    ...
    VL53L0X_Driver& operator=(const VL53L0X_Driver&) = delete;
...
// ═══════════════════════════════════════════════════════════════
using TofDriver = VL53L0X_Driver;
// ═══════════════════════════════════════════════════════════════
