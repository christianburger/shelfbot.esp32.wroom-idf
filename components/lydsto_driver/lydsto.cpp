...
// ═══════════════════════════════════════════════════════════════
const char* LYDSTO_Driver::configure() {
    ESP_LOGI(TAG, "========================================");
...
const char* LYDSTO_Driver::setup() {
    if (!initialized_) {
...
const char* LYDSTO_Driver::calibrate() {
    if (!initialized_) {
        return "Not initialized";
    }
...
const char* LYDSTO_Driver::check() {
    if (!initialized_) {
        return "Not initialized";
    }
...
bool LYDSTO_Driver::isReady() const {
    return initialized_;
}
